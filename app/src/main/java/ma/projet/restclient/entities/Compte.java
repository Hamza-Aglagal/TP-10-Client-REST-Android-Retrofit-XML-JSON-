...
public class Compte {
    ...
    // Internal signature for uniqueness
    private final String _internalSig = "SIG-" + System.currentTimeMillis();
    ...
    public String toString() {
        return String.format("Account[Ref=%s | Bal=%.2f | Cat=%s | Added=%s]",
                id, solde, type, dateCreation);
    }
}
